import { useState, useRef, useEffect } from "react"; // ⬅️ Added useRef and useEffect
import {
  Button,
  Stack,
  HStack,
  ...
  return (
    <Dialog.Root open={open} onOpenChange={(e) => setOpen(e.open)} size="md" placement="center">
      <Dialog.Trigger asChild>
        <Button size="xs" variant="outline" width="full" borderWidth={2} px={2} colorPalette="green" gap={1} onClick={(e) => e.stopPropagation()}>
